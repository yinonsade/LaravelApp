...
<section class="inner-intro bg-image overlay-light parallax parallax-background1" data-background-img="{{asset('images/about.jpg')}}">
    <div class="container">
        <div class="row title">
            <h2 class="h2">Temrs and Conditions</h2>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 text-center">
            <h2>Welcome to e218</h2>
            <p>These terms and conditions outline the rules and regulations for the use of e218's Website.</p> <br />
            <span style="text-transform: capitalize;"> e218</span> is located at:<br />
            <address> , <br /> - , <br />
                </address>
            <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use e218's
            ...
            <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
                ...
                of our assistance to the Client in the most appropriate manner, whether by formal meetings of a fixed duration,
                or any other means, for the express purpose of meeting the Client’s needs in respect of provision of the
                Company’s stated services/products, in accordance with and subject to, prevailing law of . Any use of the
                above terminology or other words in the singular, plural, capitalisation and/or he/she or they, are taken
                as interchangeable and therefore as referring to same.</p>
            <h2>Cookies</h2>
            <p>We employ the use of cookies. By using e218's website you consent to the use of cookies in accordance with e218’s
                privacy policy.</p>
            ...
            <h2>License</h2>
            <p>Unless otherwise stated, e218 and/or it’s licensors own the intellectual property rights for all material on
                e218. All intellectual property rights are reserved. You may view and/or print pages from https://www.e218.com
                for your own personal use subject to restrictions set in these terms and conditions.</p>
            <p>You must not:</p>
            <ol>
                <li>Republish material from https://www.e218.com</li>
                <li>Sell, rent or sub-license material from https://www.e218.com</li>
                <li>Reproduce, duplicate or copy material from https://www.e218.com</li>
            </ol>
            <p>Redistribute content from e218 (unless content is specifically made for redistribution).</p>
                ...
                <li>The following organizations may link to our Web site without prior written approval:
                    <ol>
                        ...
                        <li>Online directory distributors when they list us in the directory may link to our Web site in the
                            same manner as they hyperlink to the Web sites of other listed businesses; and</li>
            ...
            <p>We will approve link requests from these organizations if we determine that: (a) the link would not reflect unfavorably
                ...
                the hyperlink outweighs the absence of e218; and (d) where the link is in the context of general resource
                information or is otherwise consistent with editorial content in a newsletter or similar product furthering
            ...
            <p>These organizations may link to our home page, to publications or to other Web site information so long as the
                ...
                the linking party and it products or services; and (c) fits within the context of the linking party's site.
            </p>

            <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
                you must notify us by sending an e-mail to <a href="mailto:e218@gmail.com" title="send an email to e218@gmail.com">e218@gmail.com</a>.
            ...
            <p>No use of e218’s logo or other artwork will be allowed for linking absent a trademark license agreement.
            </p>
            <h2>Iframes</h2>
            ...
            <p>We reserve the right at any time and in its sole discretion to request that you remove all links or any particular
                ...
                reserve the right to amend these terms and conditions and its linking policy at any time. By continuing to
            ...
            <p>We shall have no responsibility or liability for any content appearing on your Web site. You agree to indemnify
                ...
                page on your Web site or within any context containing content or materials that may be interpreted as libelous,
            ...
            <p>The limitations and exclusions of liability set out in this Section and elsewhere in this disclaimer: (a) are
                ...
                to the subject matter of this disclaimer, including liabilities arising in contract, in tort (including negligence)
